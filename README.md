...
- **Word Boundaries** (`\b`): Ensures complete matches
- **Base32 Alphabet** (`[a-zA-Z2-7]`): Tor uses base32 encoding
- **Length Range** (`{16,56}`): Valid .onion address length
- **Domain** (`\.onion`): Literal ".onion" TLD
